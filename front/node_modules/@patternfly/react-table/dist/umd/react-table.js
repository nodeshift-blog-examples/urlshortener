(function (global, factory) {
    ...
    */
    ...
    const Spinner = (_a) => {
        ...
        return (React.createElement("span", Object.assign({ className: css(styles$1.spinner, styles$1.modifiers[size], className), role: "progressbar", "aria-valuetext": ariaValueText }, props),
    ...
    */
    ...
    class SelectOption extends React.Component {
        ...
        render() {
            ...
            return (React.createElement(SelectConsumer, null, ({ onSelect, onClose, variant, inputIdPrefix, onFavorite }) => (React.createElement(React.Fragment, null,
                variant !== SelectVariant.checkbox && (React.createElement("li", { id: generatedId, role: "presentation", className: css(styles$5.selectMenuWrapper, isFavorite && styles$5.modifiers.favorite, isFocused && styles$5.modifiers.focus), ref: this.liRef },
                    React.createElement(Component, Object.assign({}, props, { className: css(styles$5.selectMenuItem, isSelected && styles$5.modifiers.selected, isDisabled && styles$5.modifiers.disabled, description && styles$5.modifiers.description, isFavorite !== null && styles$5.modifiers.link, className), onClick: (event) => {
                            if (!isDisabled) {
                                onClick(event);
                ...
                variant === SelectVariant.checkbox && !isNoResultsOption && (React.createElement("label", Object.assign({}, props, { className: css(checkStyles.check, styles$5.selectMenuItem, isDisabled && styles$5.modifiers.disabled, description && styles$5.modifiers.description, className), onKeyDown: (event) => {
                        this.onKeyDown(event, 0);
                    } }),
                    ...
                    React.createElement("span", { className: css(checkStyles.checkLabel, isDisabled && styles$5.modifiers.disabled) }, children || value.toString()),
                ...
                variant === SelectVariant.checkbox && isNoResultsOption && (React.createElement("div", null,
                    React.createElement(Component, Object.assign({}, props, { className: css(styles$5.selectMenuItem, isSelected && styles$5.modifiers.selected, isDisabled && styles$5.modifiers.disabled, className), role: "option", "aria-selected": isSelected || null, ref: this.ref, onKeyDown: this.onKeyDown, type: "button" }), children || value.toString())))))));
        }
    }
    ...
    class SelectMenuWithRef extends React.Component {
        ...
        render() {
            ...
            return (React.createElement(SelectConsumer, null, ({ variant, inputIdPrefix }) => (React.createElement(React.Fragment, null,
                isCustomContent && (React.createElement("div", Object.assign({ ref: innerRef, className: css(styles$5.selectMenu, className) }, (maxHeight && { style: { maxHeight, overflow: 'auto' } }), props), children)),
                variant !== SelectVariant.checkbox &&
                    !isCustomContent &&
                    (!isGrouped ? (React.createElement("ul", Object.assign({ ref: innerRef, className: css(styles$5.selectMenu, className), role: "listbox", "aria-label": ariaLabel, "aria-labelledby": (!ariaLabel && ariaLabelledBy) || null }, (maxHeight && { style: { maxHeight, overflow: 'auto' } }), props), this.extendChildren(inputIdPrefix))) : (React.createElement("div", Object.assign({ ref: innerRef, className: css(styles$5.selectMenu, className) }, (maxHeight && { style: { maxHeight, overflow: 'auto' } }), props), this.extendChildren(inputIdPrefix)))),
                variant === SelectVariant.checkbox && !isCustomContent && React.Children.count(children) > 0 && (React.createElement(FocusTrap, { focusTrapOptions: { clickOutsideDeactivates: true, preventScroll: true } },
                    React.createElement("div", Object.assign({ ref: innerRef, className: css(styles$5.selectMenu, className) }, (maxHeight && { style: { maxHeight, overflow: 'auto' } })),
                ...
                variant === SelectVariant.checkbox && !isCustomContent && React.Children.count(children) === 0 && (React.createElement("div", Object.assign({ ref: innerRef, className: css(styles$5.selectMenu, className) }, (maxHeight && { style: { maxHeight, overflow: 'auto' } })),
    ...
    class Select extends React.Component {
        ...
        render() {
            ...
            const popperContainer = (React.createElement("div", Object.assign({ className: css(styles$5.select, isOpen && styles$5.modifiers.expanded, direction === SelectDirection.up && styles$5.modifiers.top, className) }, (width && { style: { width } })), isOpen && menuContainer));
            const mainContainer = (React.createElement("div", Object.assign({ className: css(styles$5.select, isOpen && styles$5.modifiers.expanded, direction === SelectDirection.up && styles$5.modifiers.top, className), ref: this.parentRef }, getOUIAProps(Select.displayName, ouiaId !== undefined ? ouiaId : this.state.ouiaStateId, ouiaSafe), (width && { style: { width } })),
    ...
    const TableComposableBase = (_a) => {
        var _b;
        var { children, className, variant, borders = true, isStickyHeader = false, gridBreakPoint = exports.TableGridBreakpoint.gridMd, 'aria-label': ariaLabel, role = 'grid', innerRef, ouiaId, ouiaSafe = true } = _a, props = __rest(_a, ["children", "className", "variant", "borders", "isStickyHeader", "gridBreakPoint", 'aria-label', "role", "innerRef", "ouiaId", "ouiaSafe"]);
        const ouiaProps = useOUIAProps('Table', ouiaId, ouiaSafe);
        return (React.createElement("table", Object.assign({ "aria-label": ariaLabel, role: role, className: css(className, styles$9.table, (_b = stylesGrid.modifiers) === null || _b === void 0 ? void 0 : _b[toCamel$1(gridBreakPoint || '').replace(/-?2xl/, '_2xl')], styles$9.modifiers[variant], !borders && styles$9.modifiers.noBorderRows, isStickyHeader && styles$9.modifiers.stickyHeader), ref: innerRef }, ouiaProps, props), children));
    };
    ...
    const TrBase = (_a) => {
        ...
        return (React.createElement("tr", Object.assign({ className: css(className, isExpanded !== undefined && styles$9.tableExpandableRow, isExpanded && styles$9.modifiers.expanded, isEditable && inlineStyles.modifiers.inlineEditable), hidden: isExpanded !== undefined && !isExpanded, ref: innerRef }, ouiaProps, props), children));
    };
    ...
    const cellActions = (actions, actionResolver, areActionsDisabled) => (label, { rowData, column, rowIndex, columnIndex, column: { extraParams: { dropdownPosition, dropdownDirection } }, property }) => {
        ...
        const renderProps = resolvedActions && resolvedActions.length > 0
            ...
            : {};
        return Object.assign({ className: css(styles$9.tableAction), isVisible: true }, renderProps);
    };
    ...
    const TdBase = (_a) => {
        ...
        return (React.createElement(MergedComponent, Object.assign({ "data-label": dataLabel, className: css(className, textCenter && styles$9.modifiers.center, noPadding && styles$9.modifiers.noPadding, styles$9.modifiers[modifier], mergedClassName), ref: innerRef }, mergedProps, props), mergedChildren || children));
    };
