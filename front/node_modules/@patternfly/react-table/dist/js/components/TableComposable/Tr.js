...
const TrBase = (_a) => {
    var { children, className, isExpanded, isEditable, innerRef, ouiaId, ouiaSafe = true } = _a, props = tslib_1.__rest(_a, ["children", "className", "isExpanded", "isEditable", "innerRef", "ouiaId", "ouiaSafe"]);
    const ouiaProps = react_core_1.useOUIAProps('TableRow', ouiaId, ouiaSafe);
    return (React.createElement("tr", Object.assign({ className: react_styles_1.css(className, isExpanded !== undefined && table_1.default.tableExpandableRow, isExpanded && table_1.default.modifiers.expanded, isEditable && inline_edit_1.default.modifiers.inlineEditable), hidden: isExpanded !== undefined && !isExpanded, ref: innerRef }, ouiaProps, props), children));
};
