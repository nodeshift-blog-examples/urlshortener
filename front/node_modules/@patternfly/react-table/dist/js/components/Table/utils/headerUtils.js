        ...
        ? [
            {
                ...
                transforms: onSort && canSortFavorites
                    ? [
                        transformers_1.sortableFavorites({
                            onSort,
                ...
                cellTransforms: [transformers_1.favoritable]
            }
        ]
        : [])
];
        ...
        ? [
            {
                title: '',
                transforms: [transformers_1.emptyTD],
                cellTransforms: [transformers_1.collapsible, transformers_1.expandedRow(header.length)]
            }
        ]
        : [])
];
...
const expandContent = (header, extra) => {
    ...
    return header.map((cell) => {
        ...
        return addAdditionalCellTranforms(parentIdCell, transformers_1.expandedRow(header.length));
    });
};
/**
 ...
 */
exports.mapOpenedRows = (rows, children) => rows.reduce((acc, curr, key) => {
...
const rowEditTransforms = ({ onRowEdit }) => [
    ...(onRowEdit
        ? [
            {
                title: '',
                cellTransforms: [transformers_1.editable]
            }
        ]
        : [])
];
 ...
 */
exports.calculateColumns = (headerRows, extra) => headerRows &&
    [
