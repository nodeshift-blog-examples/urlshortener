...
export declare class ActionsColumn extends React.Component<ActionsColumnProps, ActionsColumnState> {
    ...
    onSelect: (event: React.MouseEvent<any> | React.KeyboardEvent | MouseEvent, onClick: (event: React.MouseEvent, rowIndex: number | undefined, rowData: IRowData, extraData: IExtraData) => void) => void;
    render(): JSX.Element;
}
