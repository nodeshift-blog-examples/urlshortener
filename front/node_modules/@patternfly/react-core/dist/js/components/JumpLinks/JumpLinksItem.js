...
exports.JumpLinksItem = (_a) => {
    var { isActive, href, 
    // eslint-disable-next-line
    node, children, onClick } = _a, props = tslib_1.__rest(_a, ["isActive", "href", "node", "children", "onClick"]);
    return (React.createElement("li", Object.assign({ className: react_styles_1.css(jump_links_1.default.jumpLinksItem, isActive && jump_links_1.default.modifiers.current) }, props),
