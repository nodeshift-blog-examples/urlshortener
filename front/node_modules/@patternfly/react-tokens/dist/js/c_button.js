...
exports.c_button = {
  ".pf-c-button": {
    ...
    "c_button__progress_width": {
      ...
      "value": "calc(1.125rem + 0.5rem)",
      "values": [
        "calc(--pf-global--icon--FontSize--md + --pf-global--spacer--sm)",
        "calc($pf-global--icon--FontSize--md + $pf-global--spacer--sm)",
        "calc(pf-font-prem(18px) + pf-size-prem(8px))",
        "calc(1.125rem + 0.5rem)"
      ]
    },
    "c_button__progress_Opacity": {
      "name": "--pf-c-button__progress--Opacity",
      "value": "0"
    },
    ...
    "c_button_m_progress_TransitionProperty": {
      "name": "--pf-c-button--m-progress--TransitionProperty",
      "value": "padding"
    },
    "c_button_m_progress_TransitionDuration": {
      "name": "--pf-c-button--m-progress--TransitionDuration",
      "value": "250ms",
      "values": [
    ...
    "c_button_m_progress_PaddingRight": {
      "name": "--pf-c-button--m-progress--PaddingRight",
      "value": "calc(1rem + calc(1.125rem + 0.5rem) / 2)",
      "values": [
        "calc(--pf-global--spacer--md + --pf-c-button__progress--width / 2)",
        "calc($pf-global--spacer--md + calc(--pf-global--icon--FontSize--md + --pf-global--spacer--sm) / 2)",
        "calc($pf-global--spacer--md + calc($pf-global--icon--FontSize--md + $pf-global--spacer--sm) / 2)",
        "calc(pf-size-prem(16px) + calc(pf-font-prem(18px) + pf-size-prem(8px)) / 2)",
        "calc(1rem + calc(1.125rem + 0.5rem) / 2)"
      ]
    },
    "c_button_m_progress_PaddingLeft": {
      "name": "--pf-c-button--m-progress--PaddingLeft",
      "value": "calc(1rem + calc(1.125rem + 0.5rem) / 2)",
      "values": [
        "calc(--pf-global--spacer--md + --pf-c-button__progress--width / 2)",
        "calc($pf-global--spacer--md + calc(--pf-global--icon--FontSize--md + --pf-global--spacer--sm) / 2)",
    ...
    "c_button_m_in_progress_PaddingLeft": {
      ...
      "value": "calc(1rem + calc(1.125rem + 0.5rem))",
      "values": [
        "calc(--pf-global--spacer--md + --pf-c-button__progress--width)",
        "calc($pf-global--spacer--md + calc(--pf-global--icon--FontSize--md + --pf-global--spacer--sm))",
        "calc($pf-global--spacer--md + calc($pf-global--icon--FontSize--md + $pf-global--spacer--sm))",
        "calc(pf-size-prem(16px) + calc(pf-font-prem(18px) + pf-size-prem(8px)))",
  ...
  ".pf-c-button.pf-m-in-progress": {
    "c_button_PaddingRight": {
      ...
      "value": "1rem",
      "values": [
        "--pf-c-button--m-in-progress--PaddingRight",
        "--pf-global--spacer--md",
        "$pf-global--spacer--md",
        "pf-size-prem(16px)",
        "1rem"
