export const c_wizard: {
  ...
  ".pf-c-wizard": {
    ...
    "c_wizard__footer_cancel_MarginLeft": {
      "name": "--pf-c-wizard__footer-cancel--MarginLeft",
      "value": "calc(3rem - 1rem)",
      "values": [
        "calc(--pf-global--spacer--2xl - --pf-c-wizard__footer--child--MarginRight)",
        "calc($pf-global--spacer--2xl - --pf-global--spacer--md)",
        "calc($pf-global--spacer--2xl - $pf-global--spacer--md)",
